...
public class CameraPreview extends FrameLayout implements SurfaceHolder.Callback {
    ...
    public CameraPreview(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mCameraManager = new CameraManager(context);//实例化 相机管理类
        mPreviewCallback = new CameraScanAnalysis();//实例化 zbar回调类
    }
    //=======================================================暴露方法=================================================================
    /**
    ...
    public boolean start() {
        try {
            mCameraManager.openDriver();//打开相机并实例化参数
        } catch (Exception e) {
            return false;
        }
    ...
    private Camera.AutoFocusCallback mFocusCallback = new Camera.AutoFocusCallback() {
        public void onAutoFocus(boolean success, Camera camera) {
            postDelayed(mAutoFocusTask, 200);
        }
    };
